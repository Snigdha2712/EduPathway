...
@app.route('/industrytrends')
def industry_trends():
    return render_template('industry-trends.html')
@app.route('/recommend')
def recommend():
...
def pred():
    if request.method == 'POST':
        ...
        return render_template('results.html', recommendations=top_5)
    return render_template('home.html')

@app.route('/profession/<name>')
def profession_page(name):
    profession_templates = {
        "Software Engineer": "software engineer.html",
        "Lawyer": "lawyer.html",
        "Doctor": "doctor.html",
        ...
        "Business Owner": "business_owner.html",
        "Banker": "banker.html",
        "Writer": "writer.html",
        "Government Officer": "govt_officer.html",
        "Artist": "artist.html",
        "Construction Engineer": "construction_engineer.html",
        "Game Developer": "game_developer.html",
        "Stock Investor": "stock_investor.html",
        "Real Estate Developer": "real_estate_developer.html",
        "Unknown": "unknown.html",
    }

    template = profession_templates.get(name)
    if template:
